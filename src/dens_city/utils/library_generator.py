...
ATOMTYPES_DB: Dict[str, Tuple[float, float, float, int, str]] = {
    ...
    "He": (1.4311, 0.0203, 4.0026, 2, "Monoatomic Helium LJ"),
    "he": (1.4311, 0.0203, 4.0026, 2, "Monoatomic Helium LJ"),
    "Ne": (1.5827, 0.0652, 20.180, 10, "Monoatomic Neon LJ"),
    "ne": (1.5827, 0.0652, 20.180, 10, "Monoatomic Neon LJ"),
    "Ar": (1.9109, 0.2380, 39.948, 18, "Monoatomic Argon LJ"),
    "ar": (1.9109, 0.2380, 39.948, 18, "Monoatomic Argon LJ"),
    "Kr": (2.0485, 0.3398, 83.798, 36, "Monoatomic Krypton LJ"),
    "kr": (2.0485, 0.3398, 83.798, 36, "Monoatomic Krypton LJ"),
    "Xe": (2.3010, 0.4392, 131.29, 54, "Monoatomic Xenon LJ"),
    "xe": (2.3010, 0.4392, 131.29, 54, "Monoatomic Xenon LJ"),
    "Rn": (2.4413, 0.5962, 222.00, 86, "Monoatomic Radon LJ"),
    "rn": (2.4413, 0.5962, 222.00, 86, "Monoatomic Radon LJ"),
